...
export function generateMedicalReport(
    ...
    const disclaimer = "DISCLAIMER: This report is generated by an AI assistant for patient education and preliminary triage support. It is NOT a medical diagnosis. The provider must verify all findings.";
