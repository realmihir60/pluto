// This is the SINGLE SOURCE OF TRUTH for deterministic medical rules.
// Derived from lib/medical-knowledge.json

import { MedicalRule } from "./types";
...
export const MEDICAL_RULES: MedicalRule[] = [
    {
        ...
        triage_level: "urgent",
        message:
            "Fever with neck stiffness is a 'Red Flag' for Meningitis. This requires immediate ER evaluation.",
    ...
    },
    {
        ...
        message:
            "Headache accompanied by sudden vision changes requires neurological evaluation to rule out vascular issues.",
    ...
    },
    {
        ...
        message:
            "Symptoms suggest viral gastroenteritis (Stomach Flu). Maintain hydration. Seek care if dehydration occurs.",
    ...
    },
    {
        ...
        triage_level: "home_care",
        message:
            "Symptoms align with a common Upper Respiratory Infection (Cold). Rest and monitor.",
    ...
    },
    {
        ...
        triage_level: "crisis",
        message:
            "Chest pressure with shortness of breath is a Critical Pattern. Call Emergency Services (112).",
    ...
    },
    {
        ...
        triage_level: "seek_care",
        message:
            "Combination suggests classic Migraine, but rule out other causes due to vision loss.",
        confidence: "exclude",
    },
];
