                ...
                <div className="bg-white/60 dark:bg-black/40 backdrop-blur-xl border border-white/20 dark:border-white/10 rounded-3xl p-8 shadow-2xl transition-all">
                    <div className="mb-8 text-center space-y-2">
                        ...
                        <p className="text-sm text-muted-foreground">
                            Sign up to start saving your medical history securely.
                        </p>
                    </div>
                    ...
                    <div className="mt-8 text-center space-y-4">
                        <div className="text-sm text-muted-foreground font-medium">
                            Already have an account? <Link href="/login" className="text-primary hover:text-primary/80 transition-colors font-semibold">Log in</Link>
                        </div>
                        <Link
                            href="/"
